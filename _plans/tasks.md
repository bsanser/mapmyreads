...
- [ ] Task #1: P1-C1 - Remove unused mapUtilities functions
- [ ] Task #2: P1-C2 - Remove legacy country detection functions
- [ ] Task #3: P1-C3 - Delete unused service files
...
- [ ] Task #11: P3-C11 - Create ThemeContext
- [ ] Task #12: P3-C12 - Create EnrichmentContext
- [ ] Task #13: P3-C13 - Migrate page.tsx to use Contexts
